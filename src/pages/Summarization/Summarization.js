  ...
  return (
      <div className="summarizeContainer">
          ...
          <div className="summarizeText">
              <textarea readOnly id="message" rows="22" class="resize-none block mx-auto mt-3 p-3 w-11/12 text-xl text-black-900 bg-white-40 rounded-2xl border border-gray-500 dark:bg-white-700 dark:border-gray-800 dark:text-black-900"></textarea>
          </div>
